...
## Note
I have a terrible sense of naming convention, so some variable and function names are misleading. Also hardcoded ORM, which is bullshit. So have fun understanding this shitty code. Oh, and I use Arch btw.
